...
| [Does It Tick?](https://www.curseforge.com/minecraft/mc-mods/does-it-tick) | performance enhancing mod that limits entity ticking outside view distance | TeamDeusVult | Server | none |
...
| [Helium](https://www.curseforge.com/minecraft/mc-mods/sodium-reforged) | Create | Formerly known as Hydrogen Reforged, Helium is an unofficial port of Hydrogen to Forge. | someoneelsewastaken | Both | none |
