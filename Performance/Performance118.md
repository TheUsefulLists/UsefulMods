...
| [LazyDFU](https://www.curseforge.com/minecraft/mc-mods/lazydfu) | Mods that defers the DFU until its needed | LazyDFU is an optimization mod that makes the initialization of DataFixerUpper "lazy" | astei | Both | none | 
