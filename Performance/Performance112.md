...
| [Born In a Barn](https://www.curseforge.com/minecraft/mc-mods/born-in-a-barn) | Unknown | Fixes a Minecraft bug where Village doors keep chunks loaded. | Speiger | Server |
...
| [Entity Culling](https://www.curseforge.com/minecraft/mc-mods/entity-culling) | Pixelmon, Sync | Entity Culling is a small client-side performance core mod which improves the rendering of entities and tile entities. | meldexun | Client |
| [FastFurnace](https://www.curseforge.com/minecraft/mc-mods/fastfurnace) | None | Similar to FastWorkbench, it caches the last recipe used, and checks this recipe first before re-scanning the entire registry. | Shadows_of_Fire | Server (Must be installed in client as well) |
| [FastWorkbench](https://www.curseforge.com/minecraft/mc-mods/fastworkbench) | None | This is a mod aimed at improving performance of all crafting-related functions. | Shadows_of_Fire | Server (Must be installed in client as well) |
...
| [Multithreaded Noise](https://www.curseforge.com/minecraft/mc-mods/multithreaded-noise) | Unknown | This mod makes overworld terrain generate faster by replacing the three 3D noise generators in the overworld with multithreaded versions. | bloodnbonesgaming | Server | 
