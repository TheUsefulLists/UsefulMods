...
| [Nothirium](https://www.curseforge.com/minecraft/mc-mods/nothirium) | Dynamic Lighting | Nothirium is a client-side only mod that changes Minecraft's chunk rendering engine to use modern OpenGL which greatly increases performance. This mod is similar to Sodium but this is not a port of Sodium. | meldexun | Client | none |
