...
You are responasable to check anything you download from the interent using hashes (when provided), extraction software that allows you to see when is inside it, or by any means you see fit, You can also check each file using
